...
- The [`oras`](https://github.com/oras-project/oras#installation) CLI (v1.1.0+) installed locally for pushing OCI artifacts.
...
This example uses ttl.sh (an anonymous HTTPS registry) for convenience. Adjust the reference if you publish to your own registry.
