...
6. ✅ Add validation endpoint performing schema validation, render dry-run, and policy checks (Done via [PR](https://github.com/vaheed/kubeOP/compare/feat/app-validation-endpoint?expand=1)).
