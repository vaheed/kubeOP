...
- **Credential Stores** *(Done — [PR draft](https://github.com/vaheed/kubeOP/compare/main...feat/credential-stores?expand=1))*: Persist Git and registry credentials with per-user/tenant scoping and encryption.
