...
| `OPERATOR_IMAGE` | `ghcr.io/vaheed/kubeop-operator-manager:latest` | Operator container image. Update to pin specific versions. | `OPERATOR_IMAGE=ghcr.io/acme/kubeop-operator-manager:v0.11.2` |
