...
> **Security note**
>
> Git deliveries now reject symlinks, absolute/parent-relative paths, and any
> locations that resolve outside the cloned repository to avoid leaking host
> files during manifest rendering.
